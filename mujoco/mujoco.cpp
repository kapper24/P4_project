...
{
    std::vector<float> wineglass;
    wineglass = {-2.8, 0, 0, 0.4, 0.53, 0, -0.33, 0.44, 0.30, 0.37, 1.6, 0, 1.6};
    std::vector<float> cup;
    cup = { -1.63, 0.40, 0.32, 0.4, 0.57, 0, 0, 0.34, 0.27, 1.6, 1.6, 0, 1.6 };
    std::vector<float> can;
    can = { -1.54, 0, -0.32, 1.55, 0.66, 0, 0, 0.07, 0.24, 0.37, 0.34, 0, 0.24 };
    std::vector<float> targetpos;

    // activate software
    mj_activate("C:/Users/kaspe/OneDrive/Desktop/p4lecture/mujoco200_win64/bin/mjkey.txt");

    // load and compile model
    char error[1000] = "Could not load binary model";
        m = mj_loadXML("C:/Users/kaspe/source/repos/mujoco/objects.xml", 0, error, 1000);
    if (!m)
